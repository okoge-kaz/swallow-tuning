...
#$ -l h_rt=0:10:00:00
#$ -j y
#$ -o outputs/swallow-70b/instruction/
#$ -cwd
...
CHECKPOINT_SAVE_DIR="/bb/llm/gaf51275/llama/checkpoints/Swallow-70b-VE-instruct-v1.0/ichikara-lr_${LR}-minlr_${MIN_LR}-GB_${GLOBAL_BATCH_SIZE}"

mkdir -p ${CHECKPOINT_SAVE_DIR}

# dataset
DATASET_DIR=/bb/llm/gaf51275/llama/finetuning/datasets/training/ichikara
...
# job name
JOB_NAME="Swallow-70b-VE-instruct-v1.0-ichikara-BS=${GLOBAL_BATCH_SIZE}-LR=${LR}-MINLR=${MIN_LR}"
