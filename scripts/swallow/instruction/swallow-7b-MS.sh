...
#$ -l h_rt=0:10:00:00
#$ -j y
#$ -o outputs/swallow-7b-ms/instruction/
#$ -cwd
...
TOKENIZER_DIR=/bb/llm/gaf51275/llama/huggingface-checkpoint/Swallow-MS-7b-v0.1
CHECKPOINT_DIR=/bb/llm/gaf51275/llama/huggingface-checkpoint/Swallow-MS-7b-v0.1
CHECKPOINT_SAVE_DIR="/bb/llm/gaf51275/llama/checkpoints/Swallow-MS-7b-instruct-v1.0/baseline-lr_${LR}-minlr_${MIN_LR}-GB${GLOBAL_BATCH_SIZE}"
...
# job name
JOB_NAME="Swallow-MS-7b-VE-instruct-baseline-BS=${GLOBAL_BATCH_SIZE}-LR=${LR}-MINLR=${MIN_LR}"

export WANDB_ENTITY="prj-jalm"
export WANDB_PROJECT="Swallow-MS-7b-instruct"
