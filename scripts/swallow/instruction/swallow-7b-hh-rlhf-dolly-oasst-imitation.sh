...
CHECKPOINT_SAVE_DIR="/bb/llm/gaf51275/llama/checkpoints/Swallow-7b-VE-instruct-v1.0/hh-rlhf-dolly-ossat-imitation-lr_${LR}-minlr_${MIN_LR}-GB${GLOBAL_BATCH_SIZE}"
