...
CHECKPOINT_SAVE_DIR="/bb/llm/gaf51275/llama/checkpoints/Swallow-70b-VE-instruct-v1.0/hh-rlhf-dolly-ossat-imitation-lr_${LR}-minlr_${MIN_LR}-GB_${GLOBAL_BATCH_SIZE}"
...
# job name
JOB_NAME="Swallow-70b-VE-instruct-v1.0-hh-rlhf-dolly-ossat-imitation-BS=${GLOBAL_BATCH_SIZE}-LR=${LR}-MINLR=${MIN_LR}"
