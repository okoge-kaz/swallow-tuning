...
CHECKPOINT_SAVE_DIR="/groups/gaf51275/swallow-project/checkpoints/finetuning/Swallow-7b-VE-instruct-v1.0/baseline-lr_${LR}-minlr_${MIN_LR}-GB${GLOBAL_BATCH_SIZE}"
...
# job name
JOB_NAME="Swallow-7b-VE-instruct-baseline-BS=${GLOBAL_BATCH_SIZE}-LR=${LR}-MINLR=${MIN_LR}"
